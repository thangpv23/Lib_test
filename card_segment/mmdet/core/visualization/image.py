...
def imshow_det_bboxes(img,
    ...
    ax_segm, img_segm, coor_segm, ax_box, coor_box = 0
    ...
    if bboxes is not None:
        ...
        ax_box, coor_box = draw_bboxes(ax, bboxes, colors, alpha=0.8, thickness=thickness)
    ...
    if segms is not None:
        ...
        ax_segm, img_segm, coor_segm = draw_masks(ax, img, segms, colors, with_edge=True)
