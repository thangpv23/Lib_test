...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'ann/train_full_2.json',
        img_prefix=data_root + 'train_full/',
        classes=('blx_front', 'con_dau', 'passport'),
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'testset/test_full.json',
        classes=('blx_front', 'con_dau', 'passport'),
        img_prefix=data_root + 'testset/test_full',
...
evaluation = dict(metric=['bbox', 'segm'], iou_thrs =[0.8])
